...
export class VerticalPerspectiveTransform {
    ...
    transformLightDirection(dir) {
        ...
        const axisRight = [spherePos[2], 0.0, -spherePos[0]];
    ...
    _calcMatrices() {
        ...
        if (this._helper.autoCalculateNearFarZ) {
            ...
            this._helper._farZ = this.cameraToCenterDistance + globeRadiusPixels * 2.0;
        }
        ...
        mat4.scale(globeMatrixUncorrected, globeMatrixUncorrected, scaleVec);
        ...
        mat4.scale(globeMatrix, globeMatrix, scaleVec);
    ...
    isSurfacePointOnScreen(vec) {
        ...
        const projected = createVec4f64();
        vec4.transformMat4(projected, [...vec, 1], this._globeViewProjMatrixNoCorrection);
        projected[0] /= projected[3];
        projected[1] /= projected[3];
...
//# sourceMappingURL=vertical_perspective_transform.js.map