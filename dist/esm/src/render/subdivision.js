...
export function subdividePolygon(polygon, canonical, granularity, generateOutlineLines = true) {
...
export function subdivideVertexLine(linePoints, granularity, isRing = false) {
...
export function fixWindingOrder(flattened, indices) {
    const corrected = [];
...
export function scanlineTriangulateVertexRing(vertexBuffer, ring, finalIndices) {
    if (ring.length === 0) {
