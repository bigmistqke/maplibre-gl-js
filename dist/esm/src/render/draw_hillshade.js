...
export function drawHillshade(painter, sourceCache, layer, tileIDs, renderOptions) {
    ...
    if (painter.renderPass === 'offscreen') {
        ...
        if (useSubdivision) {
            ...
            renderHillshade(painter, sourceCache, layer, coords, stencilBorderless, depthMode, colorMode, false, isRenderingToTexture);
            renderHillshade(painter, sourceCache, layer, coords, stencilBorders, depthMode, colorMode, true, isRenderingToTexture);
        }
        else {
