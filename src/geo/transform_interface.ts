...
export interface IReadonlyTransform extends ITransformGetters {
     ...
     */
    get cameraToCenterDistance(): number;
    get modelViewProjectionMatrix(): Float64Array;
    get projectionMatrix(): Float64Array | Float32Array;
    /**
     * Inverse of matrix from camera space to clip space.
     */
    get inverseProjectionMatrix(): Float64Array;
     ...
     */
    get cameraPosition(): Float64Array | Tuple.Vec3;
     ...
     */
    getFastPathSimpleProjectionMatrix(tileID: OverscaledTileID): Float64Array | undefined;
}
