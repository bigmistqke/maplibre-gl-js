...
export class MercatorTransform implements ITransform {
    ...
    _calcMatrices(): void {
        ...
        this._pixelMatrix = mat4.multiply(new Float64Array(16) as any, assertedNotNullish(this.clipSpaceToPixelsMatrix), m);
        ...
        const _fogMatrix = this._fogMatrix = new Float64Array(16) as any;
        ...
        this._pixelMatrix3D = mat4.multiply(new Float64Array(16) as any, assertedNotNullish(this.clipSpaceToPixelsMatrix), m);
        ...
        m = mat4.invert(new Float64Array(16) as any, assertedNotNullish(this._pixelMatrix));
