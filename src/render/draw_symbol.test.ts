...
describe('drawSymbol', () => {
    ...
    test('should call program.draw', () => {
        ...
        tile.tileID = tileId;
        const sourceCacheMock = new SourceCache(null as any, null as any, null as any); // Test mock
        sourceCacheMock.map = {showCollisionBoxes: false} as any as Map;
        sourceCacheMock.getTile = (_a) => tile;

        const renderOptions: RenderOptions = {isRenderingToTexture: false, isRenderingGlobe: false};
        drawSymbols(painterMock, sourceCacheMock, layer, [tileId], null as any, renderOptions); // Test mock
