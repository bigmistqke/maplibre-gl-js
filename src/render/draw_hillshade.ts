...
export function drawHillshadeOffscreen(painter: Painter, tileManager: TileManager, layer: HillshadeStyleLayer, tileIDs: Array<OverscaledTileID>, _renderOptions: RenderOptions) {
