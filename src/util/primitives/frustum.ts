...
export class Frustum {
    ...
    public static fromInvProjectionMatrix(invProj: Mat4, worldSize: number = 1, zoom: number = 0, horizonPlane?: Vec4, flippedNearFar?: boolean): Frustum {
        ...
        const min: Tuple.Vec3 = [Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY, Number.POSITIVE_INFINITY];
        const max: Tuple.Vec3 = [Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.NEGATIVE_INFINITY];
