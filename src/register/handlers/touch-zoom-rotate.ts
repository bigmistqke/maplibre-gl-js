...
import type {TwoFingersTouchRotateHandler, TwoFingersTouchZoomHandler} from '../../ui/handler/two_fingers_touch';
import {TwoFingersTouchZoomRotateHandler} from '../../ui/handler/shim/two_fingers_touch';
import type {TapDragZoomHandler} from '../../ui/handler/tap_drag_zoom';
