...
export class TileManager extends Evented {
    ...
    constructor(id: string, options: SourceSpecification | CanvasSourceSpecification, dispatcher: Dispatcher, featureRegistry: FeatureRegistry) {
        super();
        this.id = id;
        ...
        this._source = createSource(id, options, dispatcher, this, featureRegistry);
    ...
    update(transform: ITransform, surface?: Surface) {
        ...
        if (isRaster && this._rasterFadeDuration > 0 && !surface?.isRenderingToTexture) {
