...
import {LineTextWorkerService} from '@modular/layers/symbol/workers/line-text-worker-service.ts';
...
import {updateLineLabels, getPitchedLabelPlaneMatrix} from '@modular/layers/symbol/vendor/projection.ts';
