// src/modular/renderer/renderer.ts
import type {CameraState, ScreenPoint, Feature, ResolvedPaintProperties, ProgramDefinition, TileID} from '@modular/core/types.ts';
import type {RendererAPI, LayerInstance, SourceDefinition, CustomLayer} from '@modular/core/renderer-api.ts';
import type {RenderExtension, RenderContext, ProgramCache} from '@modular/core/render-extension.ts';
import type {Projection, Viewport} from '@modular/core/projection.ts';
import type {TileService} from '@modular/core/tile-service.ts';
import type {Surface, RendererInternals} from '@modular/core/surface.ts';
...
import {FLAT_SURFACE} from '@modular/renderer/flat-surface.ts';
import {ELEVATION_PRELUDE} from '@modular/renderer/flat-render-tiles.ts';
