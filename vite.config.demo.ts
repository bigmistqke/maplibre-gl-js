  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'phase2-original': resolve(__dirname, 'demo/phase2/original.html'),
        'phase5-original': resolve(__dirname, 'demo/phase5/original.html'),
        'phase8-original': resolve(__dirname, 'demo/phase8/original.html'),
        'phase10-original': resolve(__dirname, 'demo/phase10/original.html'),
      },
    },
  },
})
